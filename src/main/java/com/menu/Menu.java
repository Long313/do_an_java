...
//        addMenu("Expense", "8", 8);
    ...
    private void addMenu(String menuName, String icon, int index) {
        ...
        m.setIcoName(icon);
        m.setIcon(new ImageIcon(getClass().getResource("/com/icon/" + icon + ".png")));
        ...
        for (Component com : menu.getComponents()) {
            if (com instanceof MenuButton) {
                ...
                if (!c.getIcoName().contains("_s")) {
                    c.setIcon(new ImageIcon(getClass().getResource("/com/icon/" + c.getIcoName() + ".png")));
                }
            }
        }
    }
    ...
    public void setSelectedMenu(int index) {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/icon/" + cmd.getIcoName() + "_s.png")));
    }
    ...
    private void initComponents() {
        ...
        imageAvatar1 = new com.theme.ImageAvatar();
        ...
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/icon/logo.jpg"))); // NOI18N
    ...
    private com.theme.ImageAvatar imageAvatar1;
