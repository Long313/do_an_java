    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
                layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup()
                                .addComponent(labels[0])
                                .addComponent(txtMaSP, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)) // Thêm height = 30
                        .addGroup(layout.createParallelGroup()
                                .addComponent(labels[1])
                                .addComponent(txtTenSP, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createParallelGroup()
                                .addComponent(labels[2])
                                .addComponent(txtGiaSP, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createParallelGroup()
                                .addComponent(labels[3])
                                .addComponent(txtSoLuong, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createParallelGroup().addComponent(labels[0]).addComponent(txtMaSP))
                        .addGroup(layout.createParallelGroup().addComponent(labels[1]).addComponent(txtTenSP))
                        .addGroup(layout.createParallelGroup().addComponent(labels[2]).addComponent(txtGiaSP))
                        .addGroup(layout.createParallelGroup().addComponent(labels[3]).addComponent(txtSoLuong))
                        .addGap(15)
                        .addGroup(layout.createParallelGroup()
                                .addComponent(btnThem)
                                .addComponent(btnXoa)
