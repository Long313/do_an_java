...
public class ColorOption extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        button5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/icon/color_check.png"))); // NOI18N
    ...
    private void setSelected(JButton cmd) {
        ...
        cmd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/icon/color_check.png")));
