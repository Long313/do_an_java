package com.mycompany.do_an.menu;

import com.mycompany.do_an.swing.MenuButton;
import com.mycompany.do_an.theme.SystemTheme;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void addMenu(String menuName, String icon, int index) {
        ...
        m.setIcoName(icon);
        m.setIcon(new ImageIcon(getClass().getResource("/com/mycompany/do_an/icon/" + icon + ".png")));
        ...
        for (Component com : menu.getComponents()) {
            if (com instanceof MenuButton) {
                ...
                if (!c.getIcoName().contains("_s")) {
                    c.setIcon(new ImageIcon(getClass().getResource("/com/mycompany/do_an/icon/" + c.getIcoName() + ".png")));
                }
            }
        }
    }
    ...
    public void setSelectedMenu(int index) {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/mycompany/do_an/icon/" + cmd.getIcoName() + "_s.png")));
    }
    ...
    private void initComponents() {
        ...
        imageAvatar1 = new com.mycompany.do_an.theme.ImageAvatar();
        ...
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/do_an/icon/logo.jpg"))); // NOI18N
    ...
    private com.mycompany.do_an.theme.ImageAvatar imageAvatar1;
